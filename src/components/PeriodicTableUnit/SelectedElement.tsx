	...
	return (
		...
		>
			<div className={styles.cell + ' ' + styles['element-preview']}>
				<span
					className={styles['element-preview__name'] + ' long-small'}
				>
					{element.name}
				</span>
				<span
					className={
						styles['element-preview__symbol'] + ' text-xl bold'
					}
				>
					{element.symbol}
				</span>
				<span
					className={
						styles['element-preview__number'] + ' text-normal'
					}
				>
					{element.number}
				</span>
				...
				<div className={styles['selected-element__number']}>
					...
					<div className={styles.ammunition}>
						<img
							...
							alt=""
						/>
						<span className="header-4 bold">{element.number}</span>
					</div>
				</div>
			)}
		</div>
